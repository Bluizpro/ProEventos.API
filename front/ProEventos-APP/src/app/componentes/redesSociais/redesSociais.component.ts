...
import { RedeSocialService } from '@pp/services/redeSocial.service';
...
export class RedesSociaisComponent implements OnInit {
  ...
  adicionarRedeSocial(): void {
    this.redesSociais.push(this.criarRedeSocial({ id: 0 } as RedesSocial));
  }
  criarRedeSocial(redeSocial: RedesSocial): FormGroup {
